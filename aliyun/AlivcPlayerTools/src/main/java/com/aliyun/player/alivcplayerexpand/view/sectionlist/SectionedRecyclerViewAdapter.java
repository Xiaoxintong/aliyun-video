...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * Helper method that calls {@link #notifyItemChanged} with the position of the {@link com.aliyun.player.alivcplayerexpand.view.sectionlist.Section.State}
     ...
     * the position of the {@link com.aliyun.player.alivcplayerexpand.view.sectionlist.Section.State} view holder in the adapter. Useful to be called after
